...
thumb = keycap(stemType='choc', stemTolerance=0.05, angle=-6, depth=-1.0, height=5.5)
thumb_cut = keycap(stemType='choc', stemTolerance=0.05, angle=-6, depth=-1.0, height=5.5, cut=0.8).rotate((0,0,0),(1,0,0),90)
thumb15 = keycap(stemType='choc', stemTolerance=0.05, unitY=1.5, stemRot=90, angle=-6, depth=-1.0, height=5.5)
thumb15_cut = keycap(stemType='choc', stemTolerance=0.05, unitY=1.5, stemRot=90, angle=-6, depth=-1.0, height=5.5, cut=0.8).rotate((0,0,0),(1,0,0),90)
...
if __name__ == '__main__':
    ...
    cq.exporters.export(thumb, 'generated/choc-lg/ols-v1-thumb.stl', tolerance=0.001, angularTolerance=0.05)
    cq.exporters.export(thumb_cut, 'generated/choc-lg/ols-v1-thumb-cut.stl', tolerance=0.001, angularTolerance=0.05)
    cq.exporters.export(thumb15, 'generated/choc-lg/ols-v1-thumb-1.5u.stl', tolerance=0.001, angularTolerance=0.05)
    cq.exporters.export(thumb15_cut, 'generated/choc-lg/ols-v1-thumb-1.5u-cut.stl', tolerance=0.001, angularTolerance=0.05)
    ...
    cq.exporters.export(thumb, 'generated/choc-lg/ols-v1-thumb.step')
    cq.exporters.export(thumb_cut, 'generated/choc-lg/ols-v1-thumb-cut.step')
    cq.exporters.export(thumb15, 'generated/choc-lg/ols-v1-thumb-1.5u.step')
    cq.exporters.export(thumb15_cut, 'generated/choc-lg/ols-v1-thumb-1.5u-cut.step')
